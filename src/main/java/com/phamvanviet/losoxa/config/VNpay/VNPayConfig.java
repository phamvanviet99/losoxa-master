package com.phamvanviet.losoxa.config.VNpay;
...
public class VNPayConfig {
    ...
    public static String vnp_Returnurl = "http://localhost:8082/vnpay-success";
    public static String vnp_TmnCode = "HSCT4FLU";
    public static String vnp_HashSecret = "HGTSIQGZFJEVBQGPCQMTOZRSSWCAPGSW";
