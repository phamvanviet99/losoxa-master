                            ...
                            <form:form class="form-valide" id="formSubmit" modelAttribute="blogRequest">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="avatar">
                                            <img id="thumbnail"
                                                 src="${blogResponse.thumbnail}"
                                                 class="img-fluid" style="max-width: 300px; max-height: 300px;"/>
                                        </div>
                                        <div class="file-field">
                                            <p>
                                                <strong id="Ithumbnail">${blogResponse.thumbnail.split("/")[7]}</strong><br/>
                                                <button
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea type="text" class="form-control" id="title"
                                                  name="title">${blogResponse.title}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control" name="shortDescription"
                                                  id="shortDescription">${blogResponse.shortDescription}</textarea>
                                        <form:errors path="thumbnail" cssStyle="color: red"></form:errors>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea type="text" id="content"
                                                  name="content">${blogResponse.content}</textarea>
...
<script>
    ...
    function updateNew(data) {
        $.ajax({
            url: '/api/admin/blog/${blogResponse.id}',
            type: 'PUT',
            contentType: 'application/json',
            data: JSON.stringify(data),
            dataType: 'json',
            success: function () {
                window.location.href = "/admin/blog?message=update_success";
            },
            error: function () {
                window.location.href = "/admin/blog?message=update_error";
            }
        });
    }
