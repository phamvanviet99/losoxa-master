        ...
        <div class="main-content">
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <form:form class="form-valide" action="/admin/category/create" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="file-field">
                                            ...
                                            <input type="hidden" name="categoryImage" id="image_src"/>
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label">Tên thể loại <span
